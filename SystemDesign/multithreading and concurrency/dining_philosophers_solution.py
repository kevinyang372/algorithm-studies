...
if __name__ == "__main__":
    ...
    philosopher_2 = threading.Thread(target=eat_sushi, args=("philosopher_2", chopstick_a, chopstick_b))
    philosopher_3 = threading.Thread(target=eat_sushi, args=("philosopher_3", chopstick_a, chopstick_b))
